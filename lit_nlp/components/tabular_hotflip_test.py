...
# ==============================================================================
# Lint as: python3
"""Tests for lit_nlp.components.tabular_hotflip."""
...
class ClassificationTabularHotFlipTest(absltest.TestCase):
  ...
  def setUp(self):
    ...
    self._gen = tabular_hotflip.TabularHotFlip()
  ...
  def test_hotflip_prediction_is_argmax(self):
    output = self._gen.generate(
        example=self._example,
        model=self._model,
        dataset=self._dataset,
...
class RegressionTabularHotFlipTest(absltest.TestCase):
  ...
  def test_max_num_of_changed_columns(self):
    ...
    self._config['Regression threshold'] = '0.91'
    self._config['Maximum number of columns to change'] = '1'
    self._example = {'x_1': 0.51, 'x_2': 0.5}
